...
const styles = StyleSheet.create({
  ...
  chipRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 8, borderBottomWidth: StyleSheet.hairlineWidth },
  subRow: { height: 56, overflow: "hidden", borderBottomWidth: StyleSheet.hairlineWidth },
  chipContent: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 8 },
  subChip: {
    flexDirection: "row",
    alignItems: "center",
    marginRight: 8,
  ...
  subChipText: { fontSize: 13, fontFamily: "Inter_500Medium" },
  subChipBadge: { borderRadius: 8, paddingHorizontal: 5, paddingVertical: 1, marginLeft: 4 },
  subChipBadgeText: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
